...
#     # --- Import the new error handler node ---
...
# # --- NEW ROUTER TO CHECK FOR SCRAPING ERRORS ---
# def tool_error_router(state: AgentState) -> str:
#     """Checks if the scraping tool returned an error."""
#     project_context = state.get("project_context", "")
#     if project_context == "ERROR:INVALID_URL":
#         print("---ROUTER: Tool error detected. Routing to error handler.---")
#         return "tool_error"
#     else:
#         print("---ROUTER: Tool ran successfully. Proceeding to generate questions.---")
#         return "tool_success"

# def analysis_router(state: AgentState) -> str:
#     # ... (this function remains the same)
#     category = state.get("last_answer_category", "NORMAL_ATTEMPT")
#     if category == "GAVE_UP": return "handle_give_up"
#     elif category == "UNPROFESSIONAL": return "handle_unprofessional"
#     else: return "give_acknowledgement"

# def should_ask_next_question(state: AgentState) -> str:
#     # ... (this function remains the same)
#     index = state.get("current_question_index", 0)
#     questions = state.get("interview_questions", [])
#     if index < len(questions): return "ask_next_question"
#     else: return "finish_interview"

# # Create the graph
# workflow = StateGraph(AgentState)

# # Add all nodes, including the new error handler
...
# workflow.add_node("handle_tool_error", handle_tool_error_node) # Register the new node
...
# # --- Define Graph Entry and Main Branches ---
...
# # --- Define UPDATED Question Generation Branch with Error Handling ---
# workflow.add_edge("call_scraper_tool", "run_scraper_tool")
# # AFTER running the tool, we check for an error.
# workflow.add_conditional_edges(
#     "run_scraper_tool",
#     tool_error_router,
#     {
#         "tool_success": "generate_questions", # If successful, proceed normally.
#         "tool_error": "handle_tool_error"      # If failed, go to our new error handler.
#     }
# )
# workflow.add_edge("generate_questions", "ask_question")


# # --- Define Answer Processing Flow ---
# # ... (this entire section remains the same)
# workflow.add_edge("log_answer", "analyze_answer")
# workflow.add_conditional_edges( "analyze_answer", analysis_router, { "give_acknowledgement": "give_acknowledgement", "handle_give_up": "handle_give_up", "handle_unprofessional": "handle_unprofessional" } )
# workflow.add_conditional_edges( "give_acknowledgement", should_ask_next_question, {"ask_next_question": "ask_question", "finish_interview": "generate_scorecard"} )
# workflow.add_conditional_edges( "handle_give_up", should_ask_next_question, {"ask_next_question": "ask_question", "finish_interview": "generate_scorecard"} )
# workflow.add_conditional_edges( "handle_unprofessional", should_ask_next_question, {"ask_next_question": "ask_question", "finish_interview": "generate_scorecard"} )
...
# workflow.add_edge("handle_tool_error", END) # The error path also ends the graph.
