...
def should_ask_next_question(state: AgentState) -> str:
    """
    This function manages the main interview loop. It checks if there are more
    questions to ask and decides whether to continue or finish the interview.
    """
...
# ==============================================================================
# === Graph Definition ===
# Here, we build the "wiring diagram" for our agent.
# ==============================================================================

workflow = StateGraph(AgentState)

# Register every function from our nodes file as a "node" in our graph.
...
print("---AGENT COMPILED WITH ROBUST ERROR HANDLING AND FILE SAVING---")
