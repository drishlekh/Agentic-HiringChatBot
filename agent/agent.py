...
#     if state.get("project_context") == "ERROR:INVALID_URL":
#         return "tool_error"
#     else:
#         return "tool_success"
...
# workflow.add_conditional_edges(
#     "run_scraper_tool", tool_error_router,
#     {"tool_success": "generate_questions", "tool_error": "handle_tool_error"}
# )
...
#     {"give_acknowledgement": "give_acknowledgement", "handle_give_up": "handle_give_up", "handle_unprofessional": "handle_unprofessional"}
# )
# workflow.add_conditional_edges(
...
# # After the interview finishes, we generate the scorecard.
# # After the scorecard is saved, we end the conversation.
# workflow.add_edge("generate_scorecard", "end_conversation")

# # Define where the graph should stop and wait for user input.
...
# print("---AGENT COMPILED WITH DIRECT FILE SAVING---")
